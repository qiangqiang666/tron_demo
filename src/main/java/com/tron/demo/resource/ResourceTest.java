...
public class ResourceTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        com.tron.demo.resource.model.JsonRootBean jsonRootBean = GsonUtil.getGson().fromJson(str, com.tron.demo.resource.model.JsonRootBean.class);
        ...
        com.tron.demo.resource.model.JsonRootBean jsonBean = GsonUtil.getGson().fromJson(str2, com.tron.demo.resource.model.JsonRootBean.class);
